        ...
        <div class="row">
            <div class="col-md-12">
					...
					<div class="container1" style="top:16%;font-size: 18px;" >
					  <p text-algin="left" class="name" style="font-size:18px;">About Quiz / General Instruction </p>
					   <img class="profile-img1" src="img/quiz.jpg" 
						style="margin:30px 50px 40px; height:20rem;border-radius:20px;width:35rem;clip-path:circle; position:relative; top:-20px;" align="right" alt="Quiz_image">
						...
						2) Admin has all the rights to edit or remove the existing quiz. <br>
						3) Admin can create as much quiz as he/she wants and it free to use. <br>
						4) Admin may also check how many user have applied how many times.<br>
						5) Admin can access all the data of the user.<br>
						6) All the Ranking are handled by the admin. <br>
					</div>';
                }
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;">
						<b>Enter Quiz Details</b></span>
						<br /><br />
                ...
                <?php
                    if(@$_GET['q']==4 && (@$_GET['step'])==2 ) 
                    {
						...
						<b>Enter Question Details</b></span><br /><br />
                        <div class="col-md-3"></div><div class="col-md-6">
